            ...
            function nav(side, index) {
                if (index) {
                    ...
                    if (side === 'prev') {
                        ...
                        if (slider.find('.slItem.active.active').next().length) nextItem = slider.find('.slItem.active.active').next();
                ...
                nextItem.addClass(side + 'Item').delay(50).queue(function(){
                    slider.find('.slItems > .actives > .active').addClass(side).delay(700).queue(function(){
